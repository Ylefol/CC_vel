...
HaCaT <- na.omit(read.table('extreme_res_bis_2.csv', header=T, sep=","))
...
ggsave("HaCat_reactome_peak_exp_extreme_bis_2.pdf", PlotTerms(go.results.peaks.rea[phases], top), width=10, height=9)
...
ggsave("All_reactome_peak_exp_5_non_sig.pdf", PlotTerms(go.results.comb.rea, na.omit(top2), MeltProfiler2), width=12, height=12)
